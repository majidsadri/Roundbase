    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50/80 via-white to-purple-50/60 px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">Sign in to your RoundBase account</p>
        </div>

        <form onSubmit={handleLogin} className="bg-white rounded-xl border border-gray-100 p-6 space-y-4" style={{ boxShadow: 'var(--shadow-card)' }}>
          {error && (
